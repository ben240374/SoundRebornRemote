...
| Recherche de stations | onglet Touches | radio-browser.info, interrogé directement par l'application |
| Affectation à une touche | onglet Touches | `PUT :8888/api/presets/{slot}` |
